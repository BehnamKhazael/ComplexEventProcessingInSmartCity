 ...
 * @version 0.1
 */
public class SmokeSensorType2 extends Mote implements SensorInterface {
    private static final Logger logger = getLogger(SmokeSensorType2.class);
    ...
    private int sampleRate = Integer.parseInt(getSmokeSensorType2SampleRate());
    private int sampleError = 10;
    private int id;
    ...
    public SmokeSensorType2(MoteType moteType, Simulation simulation) {
        ...
        public void run() {
            ...
            while (battery.getBatteryLevel() > 0) {
                ...
                while (isOn) {
                    ...
                    //log("Try to send pub, smoke type 2 = " + subscribersTable.size());
