 ...
 * @version 0.1
 */
public class TemperatureSensorType1 extends Mote implements SensorInterface {

    private static final Logger logger = getLogger(TemperatureSensorType1.class);
    ...
    private int sampleRate = Integer.parseInt(getTempSensorType1SampleRate());
    private int sampleError = Integer.parseInt(getTempSensorType1Error());
    private int registerError = Integer.parseInt(getTempSensorType1RegisterError());
    private int id;
    ...
    public TemperatureSensorType1(MoteType moteType, Simulation simulation) {
        ...
        public void run() {
            ...
            while (battery.getBatteryLevel() > 0) {
                ...
                while (isOn) {
                    ...
                    //log("Try to send pub, temp type 1 = " + subscribersTable.size());
