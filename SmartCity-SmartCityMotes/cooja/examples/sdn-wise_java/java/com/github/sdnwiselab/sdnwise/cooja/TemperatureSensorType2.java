 ...
 * @version 0.1
 */
public class TemperatureSensorType2 extends Mote implements SensorInterface {

    private static final Logger logger = getLogger(TemperatureSensorType2.class);
    ...
    private int sampleRate = Integer.parseInt(getTempSensorType2SampleRate());
    private int sampleError = Integer.parseInt(getTempSensorType2Error());
    private int registerError = Integer.parseInt(getTempSensorType2RegisterError());
    private int id;
    ...
    public TemperatureSensorType2(MoteType moteType, Simulation simulation) {
        ...
        public void run() {
            ...
            while (battery.getBatteryLevel() > 0) {
                ...
                while (isOn) {
                    ...
                    //log("Try to send pub, temp type 2 = " + subscribersTable.size());
//                    int size = subscribersTable.get("temp").size();
//                    String sSize = String.valueOf(size);
//                    if (!subscribersTable.isEmpty()) {
//                        log("Size: " + sSize);
//                        try {
//                            for (NodeAddress n :
//                                    subscribersTable.get("temp")) {
//                                System.out.println(n.toString());
                    try {
                        ...
                        messageInner.addProperty("topic", "temp");
    ...
    private class RegisterMessage implements Runnable {
        ...
        public void run() {
            while (!registered) {
                ...
                if (getSolution().compareTo("MUSA") == 0) {
                    messageInner.addProperty("QoS", 2);
                } else {
                    messageInner.addProperty("QoS", registerError);
                }
